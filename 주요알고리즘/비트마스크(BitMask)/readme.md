...
## 추가 (```OR 연산``)
#### S에 X를 추가 -> S의 X번째 비트를 1로 변경한다 <br>

```{1, 3, 4, 5, 9} = 570```
#### 1 추가하기
- ```570 | 2¹ = 570``` = ```570 | (1<<1)``` = ```570 (1000111010₂)```
...
#### 2 추가하기
- ```570 | 2² = 570``` = ```570 | (1<<2)``` = ```574 (1000111110₂)```
...
#### 3 추가하기
- ```574 | 2³ = 574``` = ```570 | (1<<3)``` = ```570 (1000111110₂)```
...
#### 4 추가하기
- ```570 | 2⁴ = 574``` = ```570 | (1<<4)``` = ```570 (1000111110₂)```
